...
# --- LOGIN TEMPLATE (আপডেট করা হয়েছে: ডায়নামিক ইউজার লোডিং এর জন্য) ---
LOGIN_TEMPLATE = f"""
<!doctype html>
<html lang="en">
<head>
...
# --- USER DASHBOARD (আপডেট করা হয়েছে: পারমিশন চেকের জন্য) ---
...
# --- ADMIN DASHBOARD (আপডেট করা হয়েছে: USER MANAGEMENT সহ) ---

...
# ==============================================================================
# ADMIN DASHBOARD TEMPLATE - MODERN UI WITH REAL-TIME ANIMATIONS
# ==============================================================================
...
def index():
    ...
    if not session.get('logged_in'):
        ...
        if session.get('role') == 'admin':
            # ড্যাশবোর্ড ডাটা লোড (রিয়েল-টাইম চার্ট এবং স্ট্যাটাস)
...
def generate_report():
    ...
    try:
        ...
        if not report_data:
            # ডাটা না পাওয়া গেলে Flash মেসেজ পাঠানো হচ্ছে
...
# ডাইরেক্ট ইনপুট পেজে যাওয়ার জন্য
...
def accessories_save():
    ...
    if ref in db_acc:
        ...
        # --- UPDATE STATUS LOGIC ---
        # ১. আগের সব চালানের Status টিক (✔) করে দেওয়া
